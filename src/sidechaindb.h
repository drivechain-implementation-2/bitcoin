...
class SidechainDB
{
    public:
        ...
        bool Update(const CScript& state);
        ...
        /** If nSidechain has a valid WT^, return the payout transaction */
    ...
    private:
        ...
        /** Get all of the current WT^(s) for nSidechain.
          ...
          * current period */
        std::vector<std::vector<Verification>> GetSidechainWTs(uint8_t nSidechain) const;
